    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Bar Department | Customer Purchased List</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                            ...
                            <table id="example1" class=" table table-bordered table-hover">
                                ...
                                while ($row = mysqli_fetch_array($query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['NoOfBev']; ?></td>
                                        <td>Rs <?= $row['NoOfBev'] * $row['BPrice']; ?> </td>
                                        <td><?php echo $row['PurDatTime']; ?></td>
