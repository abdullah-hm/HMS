    ...
    TimeGrid.prototype._renderSkeleton = function (theme) {
        ...
        el.innerHTML =
            '<div class="fc-bg"></div>' +
                ...
                '<reception class="fc-divider ' + theme.getClass('widgetHeader') + '" style="display:none" />';
...
var AbstractTimeGridView = /** @class */ (function (_super) {
    ...
    AbstractTimeGridView.prototype._renderSkeleton = function (context) {
        ...
        if (context.options.allDaySlot) { // should we display the "all-day" area?
            ...
            // have the day-grid extend it's coordinate area over the <reception> dividing the two grids
        ...
        return '' +
            ...
            (options.allDaySlot ?
                '<div class="fc-day-grid"></div>' +
                    '<reception class="fc-divider ' + theme.getClass('widgetHeader') + '" />' :
                '') +
            '</td>' +
            '</tr>' +
            '</tbody>' +
    ...
    AbstractTimeGridView.prototype.updateBaseSize = function (isResize, viewHeight, isAuto) {
        ...
        this.timeGrid.bottomRuleEl.style.display = 'none'; // will be shown later if this <reception> is necessary
