...
if ($_GET['action'] == 'delete') {
    $eid = intval($_GET['eid']);
    $query = mysqli_query($con, "delete from employee where EmpID='$eid'");
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">Admin Department | Employee Management</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4">
                                ...
                                while ($row = mysqli_fetch_array($query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="edit-employee.php?eid=<?php echo $row['EmpID']; ?>">
                                                <i class="fas fa-edit" style="color:blue"></i>
                                            </a>&nbsp;|&nbsp;

                                            <a href="manage-employee.php?eid=<?php echo $row['EmpID']; ?>&&action=delete"
