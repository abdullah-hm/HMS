            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="add-leave.php" class="nav-link active">
                                    <i class="nav-icon fa fa-plus "></i>
                                    <p>Add Leave</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark">HR Department | Employee Leave Management</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-4">
        ...
        <section class="content">
            ...
            <div class="row">
                    <form method="post" name="addleave">
                        <!-- SELECT2 EXAMPLE -->
                        <div class="card card-default offset-md-3 col-md-5 col-sm-12  ">
                            ...
                            <div class="card-header py-3">
                                <h5 class="m-0 font-weight-bold text-primary">Add Leave Information</h5>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <label>Leave Date</label>
                                        <div class="input-group date" id="leavedate" data-target-input="nearest">
                                            <input type="text" name="leavedate" class="form-control datetimepicker-input"
                                                   data-target="#leavedate" maxlength="<?= date("Y/m/d"); ?>" required/>
                                            <div class="input-group-append" data-target="#leavedate"
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" name = "reason"></textarea>
                                        </div>
                                    </div>
...
if (isset($_POST['addleave'])) {
    ...
    $insert = "insert into emp_leave (EmpID, Date, Type, Reason) values ( '$employeeid', '$leavedate', '$leavetype', '$reason')";
    if ($con->query($insert) === TRUE) {
        echo "<script>alert('Employee Leave Successfully Added.')</script>";
