...
//getting post values
    ...
    $query = "update payroll set EmpID='$empid',Basic='$basic',OverTime='$overtime',TravelAllowance='$travelallovance',DeductSalary='$deduct',TotalSalary='$total'   where PayrollID='$pid'";
