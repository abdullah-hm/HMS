    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Room Service Department Dashboard</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                $query2 = mysqli_query($con, "select * from room where  RoomStatus='Maintenance'");

                $a_room = mysqli_num_rows($query1);
                $m_room = mysqli_num_rows($query2);
                $totalroom = $a_room + $m_room;
